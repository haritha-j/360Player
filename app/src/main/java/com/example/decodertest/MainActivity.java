...
public class MainActivity extends AppCompatActivity {
    ...
    private void getFramesStore() {
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.frame_058_0);
    ...
    private void decodeData() {
        ...
        try {
            ...
            mediaFormat = MediaFormat.createVideoFormat(mime, 256, 180);
            ...
            getVideoFrames(decoder, outputSurface, extractor);
    ...
    private void getVideoFrames(MediaCodec decoder, OutputSurface outputSurface, MediaExtractor extractor) {
        ...
        while (!outputDone) {
            ...
            if (!inputDone) {
                ...
                if (inputBufIndex >= 0) {
                    /*ByteBuffer inputBuffer = decoderInputBuffers[inputBufIndex];
    ...
    private static class DecoderWrapper implements Runnable {

        private Throwable mThrowable;
        private MainActivity mTest;


        private DecoderWrapper(MainActivity test) {
            mTest = test;
        }
        ...
        public static void runTest(MainActivity obj) throws Throwable {
            DecoderWrapper wrapper = new DecoderWrapper(obj);
